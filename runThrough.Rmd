...
list.of.packages <- c(
    "stringr","ggplot2",  "here",  "knitr", "tidyr", "reshape2", "readr", "dplyr", "devtools", "kableExtra", "stargazer", "nlme")
...
gams.grouped <- runGams(birds.grouped, group.var = "ind", year.start = 1973)

# Run the gams in all the species (saves figs to file and exports a list of results)
gams.species <- runGams(birds.grouped %>% filter(key !="Mallard"), group.var = "key", year.start = 1973)
