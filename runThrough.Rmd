...
This model includes a factor for species identity. A smooth is produced for each species over time, and is also included as a fixed effect. A by variable may also be a matrix if covariates are matrices: in this case implements linear functional of a smooth (see gam.models and linear.functional.terms for details).


### Group trends


\@ref(tab:sppGroupTab)). Next, we analyzed individual species trends. 
