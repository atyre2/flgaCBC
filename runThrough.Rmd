...
# This chunk sources the results from analysis.R

# Unlist the list of lists
best.mod.LRresults <- ???(gamResults.list$LRresults)
best.gam.results <- ??(gamResults.list$bestGamModelResults)
